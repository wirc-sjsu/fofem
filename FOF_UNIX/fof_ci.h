...
/*-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.*/
/*                    CI fields needed for non-burnup calcs                 */
...
#define e_ShrubGroupChaparral  "ShrubGroupChaparral"
...
#define e_PinFlaWoo     "PinFlaWoo"      /* Pine Flatwoods - southeast */
...
#define e_CVT_ShrubGroupChaparral "SGC"  
...
#define e_CVT_PinFlaWoo  "PFL"     /* Pine Flatwoods - Southeast */     
...
/*-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.*/
/*                            Moisture Method                               */
/* NOTE NOTE  FOFEM 6.0 GUI just uses Entire,                               */
/*            FOFEM 6.0 batch use to allow the other types in the input file*/
/*            but DL said to remove them for batch too, see batch code      */
...
#define e_DufMoiMetDefault  e_Entire          /* Default */
...
/* Critical Fire Intensity point, 
Use Flaming on all none duff fuels
Use Duff on duff
Use the smoldering on coarse wood when Fire Intensity is < 15 kW/sq M 
Notice the f s d prefix in the variable names 
*/
float f_CriInt;  

float f_fCO, f_fCO2, f_fCH4, f_fPM25, f_fPM10, f_fNOX, f_fSO2;
float f_sCO, f_sCO2, f_sCH4, f_sPM25, f_sPM10, f_sNOX, f_sSO2;
float f_dCO, f_dCO2, f_dCH4, f_dPM25, f_dPM10, f_dNOX, f_dSO2;



/* User batch override equation numbers  */
/* tells if running batch and if it's using user equations numbers */
  char  cr_BatchEqu[25];   /* "Yes" or "No" */

#define e_EqMissing -1
#define e_EqDefault  0
  int  i_EqLit; 
  int  i_EgDufLoa; 
  int  i_EqDufDep; 
  int  i_EqMSE; 
