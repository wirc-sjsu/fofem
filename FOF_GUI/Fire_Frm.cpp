...
String ^ Str; 
  ...
  this->_chGrap_FirInt->ChartAreas["ChartArea1"]->AxisX->Maximum = this->f_LstMaxX; 

  this->_chGrap_FirInt->ChartAreas["ChartArea1"]->AxisY->Maximum = this->f_LstMaxY; 


  this->_chGrap_FirInt->Series["FirInt"]->Points->AddXY (0,0); 
  this->_chGrap_FirInt->Series["FirInt"]->Points->AddXY (0.1,0); 
  f = 0;
  i = 0; 
  sprintf (cr, "Max Intensity: %3.0f,  minute: %d", f, i );
  Str = _CharToStr (cr); 
...
/*  other values in array are for 15 second intervals - see below */
  ...
  this->_chGrap_FirInt->Series["FirInt"]->Points->AddXY (0,f); 
...
/* Get minutes that max occurred at */
  ...
  this->f_LstMaxX = this->_chGrap_FirInt->ChartAreas["ChartArea1"]->AxisX->Maximum;
  this->f_LstMaxY = this->_chGrap_FirInt->ChartAreas["ChartArea1"]->AxisY->Maximum;
