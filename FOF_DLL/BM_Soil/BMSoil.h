...
typedef struct {
    ...
    double d_Minutes;     /* mintues to apply heat */ 

    float  f_BurnTime;   /* Minutes */ 
...
#define e_SoiBulDen  1.56         /* Soil Bulk Density - mega grams */ 
#define e_SoiParDen  2.82         /* Soil Particle Density - mega grams */
