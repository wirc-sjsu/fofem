...
NOTE NOTE --> 
  ...
  >> FOFEM Does Not use this table because the species codes are the old FOFEM5 six
    letter codes, and there are new equations codes for beatle kill, see the last
    columns in the FOFEM6 fof_spp.dat file 
  >> FuelCalc uses this table to do Mortality, becuase it still uses the six character
    codes to get at the Mortality.

  I'd have to fix this table for both FOFEM and FuelCalc at the same time
