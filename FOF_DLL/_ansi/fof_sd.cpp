...
/* Set burntimes based on Moisture Condtion                                  */
   if (!xstrcmpi (a_SI->cr_MoistCond,e_Wet)){
     ...
     a_SD->i_midburn  = 150;}
      ...
      sprintf (cr_ErrMes,"%s Invalid Moisture Condition: %s", e_SoilErr, a_SI->cr_MoistCond);
      return 0; }
...
void  TmpFil_Heading (FILE *fh_Out)
{
  ...
  fprintf (fh_Out,"Column 2 - Surface temperature in celcius\n");
  fprintf (fh_Out,"Column 3 - temperature 1 centimeter from surface\n");
  fprintf (fh_Out,"Column 4->15 - subsequent layer temperatures\n");
  fprintf (fh_Out,"\n");
