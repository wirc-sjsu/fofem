...
*  _stristr.......case insensitive substring find 
*
*}{*}{*}{*}{*}{*}{*}{*}{*}{*}{*}{*}{*}{*}{*}{*}{*}{*}{*}{*}{*}{*}{*}{*}{*}{*}*/
#include <stdlib.h>
#include <stdio.h>
...
/*******************************************************
* Name: KgSq_To_Pnd
* Desc: Kilograms Square meter to pounds per acre
*******************************************************/
float KgSq_To_Pnd (float f_KgSq)
{
float f, g; 
   g = KgSq_To_TPA (f_KgSq);
   f = g * 2000.0;
   return f; 
}
/*********************************************************
* Name: PndAcre_To_GramSqMt
* Desc: Conver Pounds per ace to Grams per square meter
*  searched and found this on Google
*  1 pounds per acre = 0.112085116 grams per (square meter)
*
**********************************************************/
float PndAcre_To_GramSqMt (float f_Pnd)
{
float f; 
   f = f_Pnd * 0.112085116;
   return f; 
...
/**************************************************************
* Name _stristr 
* Desc: My case insensitve find sub-string function
* Is the B string in the A string
***************************************************************/
char * _stristr (char A[], char B[])
{
char a[2000], b[2000];
