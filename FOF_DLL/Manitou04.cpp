/*****************************************************************************
* Name: Manitou04.cpp
* Desc: --->>  Based on Quincy1G with Bill's changes; asb 02Feb18
*
******************************************************************************/
#include <stdio.h>
#include <string.h>
...
// global numf1 numf2
 ...
 if  ( THETAR == 1 ) {
   thetar  = 0.01;
//   psini   = xxxxxxe-01; 
   strcpy (bmi->cr_ErrMes,"Manitou04() fix this - psini = xxxxxxe-01 "); 
   return 0;  }   
 else {
   thetar  = 0;
   psini   = 1.449242e-03; //= e_SoiWatPot;   /* normalized soil water potential  */
   numf1   = 0;
   numf2   = 0;
 }  // end
...
Mexp    = 0.3099;
  ...
  if ( THETAR == 1 ) {
     ...
     strcpy (bmi->cr_ErrMes,"Manitou04() fix this, XXXXXXe-05"); 
     return 0; 
  }
  else
