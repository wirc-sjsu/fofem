...
// typedef class FOF_EXPORT d_LCC {
 ...
 void   CI_Set_EmisFactor ( char cr_Type[], char cr_GrpNum[], float f_CO, float f_CO2, float f_CH4, float f_PM25, float f_PM10, float f_NOX, float f_SO2);
 ...
 void  CO_GetEmTot (char cr[], float *PM25, float *PM10, float *CH4, float *CO2, float *CO,  float *NOX, float *SO2);
...
/*----------------------------------------------------------*/
 ...
 void MIS_CrnDam (float f);     /* Crown Damage */
 void MIS_CKR    (float f);     /* Cambium Kill Ratio */
 void MIS_BeeDam (char cr[]);   /* Beetle Damage */
 void MIS_BolCha (float f);     /* Bole Char height */  
 void MIS_EquTyp (char cr[]);    /* Equation Type - Crown Scorch, Damage, or Bole Char */
